...
/**
 * ZodiacbirthstonesFixture
 *
 */
class ZodiacbirthstonesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sign' => ['type' => 'string', 'length' => 12, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
